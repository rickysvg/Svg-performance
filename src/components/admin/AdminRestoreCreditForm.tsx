...
import { restoreCreditAction, type AdminActionState } from "@/app/actions/admin";
import { StatusBanner } from "@/components/StatusBanner";
import { CREDIT_KINDS, CREDIT_LABELS } from "@/lib/plans";

export function AdminRestoreCreditForm({ userId }: { userId: string }) {
