...
3. Training → **Calendar** (Today / Tomorrow list, lime today-dot) → tap a DEMO workout card → day overview (equipment chips + thumbs) → **Start Now** → log Previous / Reps / Lbs → tap **Watch form** (YouTube) → Save → refresh History
...
- [ ] Train: **Calendar** lists Today / Tomorrow with DEMO cards; a workout card opens the day overview (equipment chips + thumbs); **Start Now** opens the logger (Previous / Reps / Lbs); **Watch form** opens a YouTube technique video (or shows pending); a logged workout survives refresh; a wrong number can be corrected.
